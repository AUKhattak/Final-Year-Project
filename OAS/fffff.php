 ...
 <li class="active" ><a href="student_question.php"><span class="fa fa-caret-right"></span> Attempt Question </a></li>
   ...
   <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">Attempt Test Qustion Here </h1>
            
            <p id="timer"></p>
                    <ul class="breadcrumb">
            <li><a href="index.html">Home</a> </li>
            <li><a href="users.html">Add Test Quston here</a> </li>
...
var q_id = $("#q_id").val();
var code = $("#code").val();
//alert(batch+dept+roll);
 $.post("signatory/check.php",{s_id:s_id,q_id:q_id,code:code}, function(data){
        if(data==0)
		{
