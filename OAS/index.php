...
<div style="width:1490px; margin-left:auto; margin-right:auto; ">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <a class="" href="index.php"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> Online Assessment</span></a></div>
           <?php 
...
<div style="width:1490px; margin-left:auto; margin-right:auto; ">
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 style="font-size:36px;">Welcome to Online Assessment</h1>
        ...
        <div id="page-stats" class="panel-collapse panel-body collapse in">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                           ...
                           <a href="users.php">  <img src="images/community-student-icon.png" style="width:220px; height:220px;">
                             </a>
                             </div>
                                <h3 class="text-muted text-center" style="font-size:24px; color:#000000;">Student</h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="knob-container">
                         ...
                         <a href="conductor_list.php">    <img src="images/Professor.png" style="width:220px; height:220px;">
                                 ...
                                 <h3 class="text-muted text-center" style="font-size:24px; color:#000000;">Teacher</h3>                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="knob-container">
                             <div style="width:230px; height:230px; margin-top:20px;">
                           <a href="subject_list.php">  <img src="images/Double-J-Design-Ravenna-3d-Books.ico" style="width:220px; height:220px;">
                             </a>
                             </div>
                                <h3 class="text-muted text-center" style="font-size:24px; color:#000000;">Subject</h3>
