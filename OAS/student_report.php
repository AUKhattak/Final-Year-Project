...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <div style="width:1000px; height:700px; margin-left:auto; margin-right:auto; border:solid 2px; margin-top:10px; border-radius:4px;">
     <h1 style="margin-left:300px; float:left; margin-top:50px;">Student Report</h1><br>
      <?php

mysql_connect("localhost","root","");
mysql_select_db("oas"); 
if(isset($_GET['s_id']) && ($_GET['id'])){
$id = $_GET['code']; 
$s_id =$_GET['s_id'];

$result = mysql_query("SELECT student_question.*,student.*,test.*,subject.* FROM  student_question
...
INNER JOIN subject ON test.subject_id = subject.subject_id
  ...
  where  student_question.t_code = '$id' AND student.student_id='$s_id' ");
...
?>
     ...
     <table  style="width:700px; margin-left:auto; margin-right:auto; margin-top:150px; border:solid 2px;">
