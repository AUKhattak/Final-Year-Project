...
?>
  ...
  <tbody>
    <tr>
         ...
         <div id="no_print">
                       <center>
                            <button type="submit"  class="btn btn-primary btn_submit" onClick="window.history.back(-1) " style="width:80px; margin-left:-830px;">Go Back</button>
                      		<button type="submit" class="btn btn-primary btn_submit hidden-xs" onClick="window.print() " style="width:80px;
                            ">Print</button>
                       </center>     
                      </div>
