  ...
  <div class="sidebar-nav">
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">Student Attempt  List</h1>
                    <ul class="breadcrumb">
            <li><a href="index.php">Home</a> </li>
            <li><a href="test_list.php">Test List</a> </li>
            <li><a href="">Student Attempt List</a> </li>
        </ul>
...
?>
   ...
   <td><?php echo $row['name'];?></td>
      ...
      <td>
                <a href="student_report1.php?id=<?php echo $row['t_code']; ?>&s_id=<?php echo $row['student_id']; ?>"><i class="fa fa-file-zip-o fa-2x"></a></td>
