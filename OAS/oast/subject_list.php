   ...
   <div class="sidebar-nav">
    ...
    <li data-popover="true"rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-book"></i> Test Conductor<i class="fa fa-collapse"></i></a></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse in">
            ...
            <li class="active" ><a href="subject_list.php"><span class="fa fa-caret-right"></span>Subject List</a></li>
...
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary"><i class="fa fa-plus"></i><a href="add_subject.php"> New Subject</a></button>
...
<table class="table">
 ...
 INNER JOIN subject on teacher_conductor.subject_id = subject.subject_id
WHERE teacher_conductor.user = '$id'");
if($result === FALSE) { 
    die(mysql_error()); // TODO: better error handling
}
...
?>
      ...
      <td>
            <a href="d_subject.php?del=<?php echo $row['subject_id']; ?> "<i class="fa fa-trash-o"></a>
      </td>
    </tr>
   <?php } }?>
