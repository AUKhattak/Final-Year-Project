...
<div style="width:1490px; margin-left:auto; margin-right:auto; ">
  ...
  <ul>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse ">
        ...
        <li><a href="index.php" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-file-text"></i> Manage Test<i class="fa fa-collapse"></i></a></li>
...
$result="SELECT * FROM  question where  t_code = '$id' limit=1 ";
$run=mysql_query($result);
?>
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary"><i class="fa fa-plus"></i><a style="color:#FFFFFF;" href="add_question.php?id=<?php echo $id; ?>">Add Question Here</a></button>
 <?php }?>
  <div class="btn-group">
  </div>
</div>
...
$result="SELECT * FROM  question where  t_code = '$id' ";
