...
mysql_connect("localhost","root","");
mysql_select_db("oas"); 
 $qry="select test.*,subject.* from test
 inner join subject on subject.subject_id = test.subject_id
 ORDER BY `test`.`subject_id`";
...
<td><a href="result.php?id=<?php echo $row['t_code'];?>"<i class="fa fa-pencil-square-o" aria-hidden="true"></i></td>
    </tr>
   <?php } ?>
