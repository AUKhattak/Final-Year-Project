   ...
   <ul>
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 style="margin-left:500px; font-size:24px;" class="page-title">Subject List</h1>
...
<table class="table">
 ...
 <tr style="background-color:#272750; color:#FFFFFF;">
  ...
  {
  $id =$_SESSION['user'];
 $result = mysql_query("select subject.*,subject_register.*,student.*,teacher_conductor.* from subject 
 CROSS JOIN teacher_conductor ON teacher_conductor.subject_id= subject.subject_id
...
?>
      ...
      <td>
            ...
            <a href="student_test_list.php?id=<?php echo $row['subject_id'];?>"<i class="fa fa-file-text fa-lg" aria-hidden="true"></i>
      </td>
